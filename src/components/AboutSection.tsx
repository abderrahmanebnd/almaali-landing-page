...
const AboutSection = () => {
  const features = [
    ...
    },
    {
      icon: MapPin,
      title: "موقع متميز",
      description: "حمام ضلعة بالقرب من البريد الوطني , Hammam Dalaa, Algeria",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            أكاديمية زينو للتعليم والتدريب ، مؤسسة تعليمية رائدة تهدف إلى تطوير
            قدرات الطلاب وإعدادهم لمستقبل أكاديمي ومهني متميز من خلال برامج
            تعليمية شاملة ومبتكرة.
          </p>
        </div>
